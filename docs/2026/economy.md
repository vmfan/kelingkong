...
| 2026-09-12 | **Same-day 15-minute retime: last heats, submission deadline, regroup, and closing all moved 15 minutes earlier.** Last heat now 16:15 (ends 16:30), submission deadline 16:30 (kept flush against last-heat-end, same design as the 2026-09-04 entry), regroup 16:30–17:00, closing 17:00. Live exploration falls further, to ~3h55m. Only mission M4 depended on last-heats/Form-close; **kept unchanged at `issued_at` 15:44 / `deadline` 16:04** to preserve the 60-minute even afternoon spacing with M3, rather than sliding it 15 minutes earlier — its end-of-day buffer shrinks accordingly, from 26/41 minutes to 11/26 minutes (still positive). M1–M3 untouched. Full derivation in `missions-build-spec.md`'s "Broadcast schedule" | Requested same-day. Applied the same "deadline flush against last-heat-end" invariant from 2026-09-04 rather than moving the deadline in isolation, since an isolated 15-minute pull-forward would have stranded teams still on the last heat with no time left to submit. For M4 specifically, chose to preserve even spacing over preserving the original buffer margin — an initial draft slid M4 earlier too (to 15:29/15:49) to keep the 26/41-minute buffers exactly, but that broke the stated 60-minute spacing design goal; reverted once flagged. **Live Sheet and `Code.gs` not yet updated** — same outstanding step as the 2026-09-04 entry, now also covering the new `CONFIG.DEADLINE`/error-string values (M4's row in the live Sheet needs no change) |
